...
import { ChevronLeft, ChevronRight, TrendingUp, Users, Target, MapPin, Package, Rocket } from 'lucide-react';
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="p-4 bg-primary/5 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Youth unemployment and rural-urban migration threaten Bhutan's agricultural sector
            ...
            <div className="p-4 bg-primary/5 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                A pedagogy that combines structured training with real production, enabling students
        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg">
              <div className="text-4xl font-bold text-primary">{metrics.totalCourses}</div>
              <div className="text-sm font-medium mt-2">Active Courses</div>
              <div className="text-xs text-muted-foreground mt-1">Across 3 production areas</div>
            </div>
            <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg">
              <div className="text-4xl font-bold text-primary">{metrics.totalProjects}</div>
              <div className="text-sm font-medium mt-2">Ongoing Projects</div>
              <div className="text-xs text-muted-foreground mt-1">Hands-on learning</div>
            </div>
            <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg">
              <div className="text-4xl font-bold text-primary">{metrics.totalEnrollments}</div>
              <div className="text-sm font-medium mt-2">Student Enrollments</div>
              <div className="text-xs text-muted-foreground mt-1">Active participants</div>
            </div>
            <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg">
              <div className="text-4xl font-bold text-primary">{metrics.averageProgress}%</div>
              <div className="text-sm font-medium mt-2">Completion Rate</div>
              <div className="text-xs text-muted-foreground mt-1">Student progress</div>
            </div>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="p-4 border rounded-lg">
              ...
              <div className="text-sm font-medium mt-1">Hydroponic Production</div>
              <div className="text-xs text-muted-foreground">Monthly average output</div>
            </div>
            <div className="p-4 border rounded-lg">
              <div className="text-2xl font-bold text-primary">
              ...
              <div className="text-xs text-muted-foreground">Monthly production</div>
            </div>
            <div className="p-4 border rounded-lg">
              <div className="text-2xl font-bold text-primary">
              ...
              <div className="text-xs text-muted-foreground">Monthly output</div>
            </div>
          </div>
        </div>
      ),
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Fresh produce, seedlings, and bamboo products sold to local markets
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Subsidized fees from students with government support programs
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-primary/5 rounded-lg">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Practical experience leads to immediate employment or entrepreneurship
                  </div>
                </div>
                <div className="p-4 bg-primary/5 rounded-lg">
        ...
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="p-6 border-2 border-primary/20 rounded-lg">
              ...
              <h3 className="font-semibold text-lg mb-3">Gelephu Mindfulness City</h3>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
                  <span>Sustainable agriculture practices aligned with mindful development</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
                  <span>Youth employment creation in green economy sectors</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
            ...
            <div className="p-6 border-2 border-primary/20 rounded-lg">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
                  <span>Agricultural productivity increase through modern techniques</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
                  <span>Value-added production and processing capabilities</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
                  <span>Entrepreneurship ecosystem for agricultural startups</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="p-6 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg">
            <h3 className="font-semibold text-lg mb-2">Impact on Rural Development</h3>
            <p className="text-sm text-muted-foreground">
              By keeping youth engaged in agriculture through modern, profitable methods, we address
              rural-urban migration while building food security and economic resilience in rural communities.
            </p>
          </div>
        </div>
      ),
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-6 p-4 bg-primary/5 rounded-lg">
                ...
                <div className="text-sm text-muted-foreground">
                  Ongoing technical support, quarterly reviews, and access to our learning community
                </div>
              </div>
            </div>
          </div>
