...
const translations: Record<string, Record<Language, string>> = {
  ...
  "home.hero.subtitle": {
    en: "Empowering Bhutanese Farmers Through Modern Agriculture",
    dz: "དེང་རབས་ཞིང་ལས་ཀྱིས་འབྲུག་གི་ཞིང་པ་རྣམས་ལ་ནུས་པ་སྤྲོད་པ",
  },
  "home.objectives": { en: "Our Objectives", dz: "ང་ཚོའི་དམིགས་ཡུལ" },
  "home.stories": { en: "Farmer Success Stories", dz: "ཞིང་པའི་གྲུབ་འབྲས་གཏམ" },
  "techniques.title": {
    en: "Farming Techniques Library",
    dz: "ཞིང་ལས་ལག་རྩལ་མཛོད",
  },
...
let globalLanguage: Language =
  (sessionStorage.getItem("gfa_language") as Language) || "en";
