        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              A proven training + production hybrid model for sustainable
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Our training-production hybrid model addresses youth unemployment
              and rural migration by combining structured agricultural education
              with real production experience. Students earn while they learn,
              developing job-ready skills and entrepreneurial capabilities.
            </p>
            <p className="text-muted-foreground">
              This pedagogy aligns with Bhutan's GMC (Gelephu Mindfulness City)
              vision and 10x GDP growth strategy, creating sustainable pathways
              for agricultural development and youth employment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 border-t bg-primary/5">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Contact us for implementation support, training, or partnership
              opportunities. We provide comprehensive resources and ongoing
