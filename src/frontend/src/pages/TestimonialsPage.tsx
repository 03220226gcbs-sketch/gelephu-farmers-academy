...
import { MapPin, MessageSquareQuote, PlusCircle, Sprout } from "lucide-react";
      ...
      <section className="relative bg-gradient-to-br from-primary/10 via-background to-accent/10 py-12 sm:py-20 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
            Real stories from farmers who have transformed their livelihoods
            through modern agricultural practices at Gelephu Farmers Academy.
          </p>
          <Button
            size="lg"
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 sm:py-24">
            ...
            <p className="text-muted-foreground max-w-md mx-auto mb-8 text-sm sm:text-base">
              No testimonials yet. If you've benefited from our programs, we'd
              love to hear about your farming journey and success.
            </p>
            <Button
              size="lg"
              className="min-h-[48px] w-full sm:w-auto gap-2"
