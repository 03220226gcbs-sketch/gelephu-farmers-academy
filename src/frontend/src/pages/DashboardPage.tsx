...
import { Droplets, Sprout, TreePine, TrendingUp } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const { data: hydroponicMetrics, isLoading: hydroponicLoading } =
    useGetMetricsByType("hydroponic");
  const { data: nurseryMetrics, isLoading: nurseryLoading } =
    useGetMetricsByType("nursery");
  const { data: bambooMetrics, isLoading: bambooLoading } =
    useGetMetricsByType("bamboo");

  if (!identity) {
    return (
      <AccessDeniedScreen message="Please login to access the dashboard" />
    );
  }
          ...
          <Card key={Number(metric.id)}>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Updated:{" "}
                {new Date(
                  Number(metric.timestamp) / 1000000,
                ).toLocaleDateString()}
              </p>
            </CardContent>
          </Card>
    ...
    <div className="container py-12">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Monitor real-time metrics and performance indicators across all
          production areas.
        </p>
      </div>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Water-based cultivation systems and nutrient management
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Seedling production and plant propagation
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    Sustainable bamboo cultivation and harvesting
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
