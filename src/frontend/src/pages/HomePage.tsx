...
const featureCards = [
  {
    ...
    description:
      "Hands-on courses in hydroponics, bamboo cultivation, and nursery management.",
  ...
  },
  {
    ...
    description:
      "Real testimonials from farmers who transformed their livelihoods.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
              Empowering Bhutan's <span className="text-primary">Farmers</span>{" "}
              for a <span className="text-primary">Prosperous Future</span>
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-8 leading-relaxed">
              Join the Gelephu Farmers Academy to master modern agricultural
              techniques, contribute to national GDP growth, and build
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
            Comprehensive resources and programs designed to transform Bhutanese
            agriculture.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <Card className="border-primary/20">
              <CardContent className="pt-6 pb-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  To be the leading agricultural training institution in Bhutan,
                  producing skilled farmers who drive sustainable economic
                  growth.
                </p>
              </CardContent>
            </Card>
            <Card className="border-primary/20">
              <CardContent className="pt-6 pb-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Empowering farmers through practical education, modern
                  techniques, and market linkages to achieve food security and
                  prosperity.
                </p>
              </CardContent>
            </Card>
            <Card className="border-primary/20">
              <CardContent className="pt-6 pb-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Train 1,000+ farmers annually, achieve 40% yield improvements,
                  and contribute significantly to Bhutan's 10x GDP growth
                  target.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-12 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-muted-foreground mb-8 text-sm sm:text-base">
            Join hundreds of farmers already benefiting from our programs.
            Register today and start your journey toward a more prosperous
            future.
          </p>
