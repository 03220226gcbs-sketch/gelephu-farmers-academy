...
export default function StorePage() {
  ...
  const [selectedProduct, setSelectedProduct] =
    useState<CoursewareProduct | null>(null);
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-black/20 flex items-center">
          <div className="container">
            ...
            <p className="text-white/80 text-lg max-w-2xl">
              Purchase high-quality training materials, guides, and course
              packages developed by our expert instructors.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex items-start gap-3 p-4 rounded-lg bg-primary/5 border border-primary/20">
          ...
          <div>
            <p className="text-sm font-medium">
              All prices are in Bhutanese Ngultrum (Nu.)
            </p>
            <p className="text-sm text-muted-foreground">
              Login required to complete a purchase. Materials are available for
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  onClick={() =>
                    setQuantity((q) =>
                      Math.min(Number(selectedProduct?.inventory || 1), q + 1),
                    )
                  }
      ...
      <Dialog open={showLoginPrompt} onOpenChange={setShowLoginPrompt}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              You need to be logged in to purchase courseware materials. Please
              login to continue.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
