...
import type { NewsItem, TeamMember } from "../../backend";
import {
  useGetPublicContent,
...
export default function ContentManagement() {
  ...
  const addNewsItem = () => {
    setNews([
      ...news,
      { title: "", content: "", date: BigInt(Date.now() * 1000000) },
    ]);
  };
  ...
  const updateNewsItem = (
    ...
    if (field === "date") {
      updated[index] = {
        ...updated[index],
        date: BigInt(new Date(value).getTime() * 1000000),
      };
    } else {
      updated[index] = { ...updated[index], [field]: value };
    }
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                The mission statement is protected and cannot be edited through
                this form.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Tip: Enter each objective on a new line or use bullet points (•)
                to separate them.
              </p>
            </div>
          </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="flex-1 space-y-3">
                      ...
                      <Input
                        type="date"
                        value={
                          new Date(Number(item.date) / 1000000)
                            .toISOString()
                            .split("T")[0]
                        }
                        onChange={(e) =>
