import { Heart, Leaf, MessageCircle, Phone } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Empowering Bhutanese farmers with modern agricultural techniques
              to achieve sustainable livelihoods and contribute to national GDP
              growth.
            </p>
          </div>
