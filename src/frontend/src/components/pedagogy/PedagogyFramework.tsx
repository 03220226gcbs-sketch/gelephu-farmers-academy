  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Badge
          variant="secondary"
          className="flex items-center gap-1 w-fit px-3 py-1.5 text-sm"
        >
          <Lock className="h-4 w-4" />
          View Only — GGSA Proprietary
        </Badge>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-sm text-muted-foreground mt-4">
            Our unique approach integrates theoretical learning with practical
            production experience, enabling students to earn while they learn
            and develop real-world agricultural skills.
          </p>
        </CardContent>
      </Card>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Modern soilless farming techniques with focus on system
                  design, nutrient management, and optimization strategies.
                </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Seedling production and propagation covering germination,
                  transplanting, and quality control.
                </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Sustainable bamboo farming including species selection,
                  maintenance, and value-added processing.
                </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Theoretical knowledge, safety protocols, basic techniques,
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium">
                    Supervised Practice (Weeks 5-8)
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    Hands-on training, guided production tasks, quality
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-medium">
                    Independent Production (Weeks 9-12)
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    Autonomous operations, production responsibility, mentoring,
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Business planning, market analysis, financial management,
