...
export default function TestimonialSubmissionDialog({
  open,
  onOpenChange,
  isAuthenticated,
}: Props) {
      ...
      <DialogContent className="w-[calc(100vw-2rem)] max-w-lg sm:max-w-lg rounded-xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm">
            Inspire other farmers by sharing your experience with Gelephu
            Farmers Academy.
          </DialogDescription>
        </DialogHeader>
        ...
        {!isAuthenticated ? (
          <div className="py-8 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Please log in to share your testimonial. This helps us verify
          ...
          <div className="py-8 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Your testimonial has been submitted and is pending admin
                approval. It will appear on the page once reviewed.
              </p>
            </div>
            <Button className="min-h-[44px] w-full" onClick={handleClose}>
              Close
